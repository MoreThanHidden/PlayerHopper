...
public class PlayerHopper implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "playerhopper"), PlayerHopperBlockEntities.PLAYER_HOPPER);
